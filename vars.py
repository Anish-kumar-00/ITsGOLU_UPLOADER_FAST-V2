...
# API Configuration
API_ID = int(os.environ.get("API_ID", "34677259"))
API_HASH = os.environ.get("API_HASH", "f149c400ef1ee7662fcd6e74d6529d5b")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8922703959:AAFtLcR2M1IsyHjvqzwVAuT2ksGM58jOZtc")

CREDIT = os.environ.get("CREDIT", "𝐈𝐓'𝐬𝐆𝐎𝐋𝐔")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "Telegrambot")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://<db_username>:3DGoh7sYhfdKCwcx@extractordb.cu1uofn.mongodb.net/?appName=ExtractorDB")  # Add your own atlas db
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "5968883359"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "5968883359").split()]  # Default to owner ID

# Channel Configuration
PREMIUM_CHANNEL = ""
# Thumbnail Configuration
THUMBNAILS = list(map(str, os.environ.get("THUMBNAILS", "").split())) if os.environ.get("THUMBNAILS") else [] # Image Link For Default Thumbnail 
